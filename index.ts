...
charClass.lcChar = charClass.Ll + charClass.Lt + charClass.Lm + charClass.Lo + charClass.Mn + charClass.Mc + charClass.Nd + charClass.Nl

const implicitlyNoCased = {
  leadingCap: new RegExp(`^[${charClass.Lu}][${charClass.lcChar}]+[${charClass.P}]?$`),
  joined: new RegExp(`^[${charClass.Lu}][${charClass.lcChar}]*(-[${charClass.Lu}][${charClass.lcChar}]+)*[${charClass.P}]?$`),
